...
const filteredGraph = computed(() => {
  ...
  // Include neighbors (1 hop) of any matching node so context is preserved
...
onMounted(async () => {
  // Scope param is "user/<id>" or "org/<id>"; default = current user
  const raw = String(route.params.scope ?? '')
