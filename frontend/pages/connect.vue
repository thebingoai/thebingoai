          ...
          <div v-if="sampleConnection" class="mb-8">
            ...
            <div class="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <!-- Icon -->
                <div class="h-7 w-7 shrink-0" v-if="connectorIcons[sampleConnection.db_type]" v-html="connectorIcons[sampleConnection.db_type]" />
          ...
          <div>
            ...
            <div class="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <div class="h-7 w-7 shrink-0" v-if="connectorIcons[type.id]" v-html="connectorIcons[type.id]" />
