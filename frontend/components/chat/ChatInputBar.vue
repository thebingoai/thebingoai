  ...
  <div ref="containerRef" class="relative">
    <div class="px-14 pb-6">
      ...
      <div class="max-w-[760px] mx-auto relative">
        ...
        >
          <!-- Attachment preview strip (excludes files retained for Source 0 after send) -->
          <div v-if="attachedFiles.some(f => !f.sentWithMessage)" class="flex flex-wrap gap-2 mb-2">
            <div v-for="(file, index) in attachedFiles" :key="index" class="group">
              <ChatFilePreview v-if="!file.sentWithMessage" :file="file" :index="index" @remove="removeFile" />
            </div>
          </div>
