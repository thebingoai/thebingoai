<template>
  <div class="flex flex-col h-full overflow-hidden">
    <div class="px-7 pt-[18px] pb-4 border-b border-[var(--line)] flex-shrink-0">
      ...
      <h1 class="settings-h1 text-3xl text-gray-900 dark:text-white">Credits & API Keys</h1>
    </div>
      ...
      <div class="rounded-xl border border-gray-200 dark:border-neutral-700 p-6 flex flex-col gap-3">
        ...
        <div class="h-1 rounded-full bg-gray-100 dark:bg-neutral-700 overflow-hidden">
          <div
            ...
            :class="usedPercent >= 90 ? 'bg-red-500' : 'bg-orange-500/70'"
    ...
    <div class="rounded-xl border border-gray-200 dark:border-neutral-700 p-6 space-y-4">
      <div>
        ...
        <p class="text-sm text-gray-500 dark:text-neutral-400 mt-1">Save Bingo-hosted credits for your own provider. Bypasses daily limits, rolls up on your invoice, not ours.</p>
      </div>
